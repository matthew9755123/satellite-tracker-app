 ...
 *
 * @license MIT
 */function xd(){return xd=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(t[i]=n[i])}return t},xd.apply(this,arguments)}const Wy=zt.createContext(null),dv=zt.createContext(null);function Xy(){return zt.useContext(dv)!=null}function jy(t){let{basename:e="/",children:n=null,location:i,navigationType:r=Nr.Pop,navigator:o,static:s=!1,future:a}=t;Xy()&&av(!1);let l=e.replace(/^\/*/,"/"),u=zt.useMemo(()=>({basename:l,navigator:o,static:s,future:xd({v7_relativeSplatPath:!1},a)}),[l,a,o,s]);typeof i=="string"&&(i=uv(i));let{pathname:d="/",search:f="",hash:h="",state:m=null,key:_="default"}=i,y=zt.useMemo(()=>{let p=Vy(d,l);return p==null?null:{location:{pathname:p,search:f,hash:h,state:m,key:_},navigationType:r}},[l,d,f,h,m,_,r]);return y==null?null:zt.createElement(Wy.Provider,{value:u},zt.createElement(dv.Provider,{children:n,value:y}))}new Promise(()=>{});/**
...
#define LOW_PRECISION`),e}function Rw(t){let e="SHADOWMAP_TYPE_BASIC";return t.shadowMapType===fv?e="SHADOWMAP_TYPE_PCF":t.shadowMapType===Qy?e="SHADOWMAP_TYPE_PCF_SOFT":t.shadowMapType===Mi&&(e="SHADOWMAP_TYPE_VSM"),e}function Pw(t){let e="ENVMAP_TYPE_CUBE";if(t.envMap)switch(t.envMapMode){case $o:case Ko:e="ENVMAP_TYPE_CUBE";break;case hu:e="ENVMAP_TYPE_CUBE_UV";break}return e}function bw(t){let e="ENVMAP_MODE_REFLECTION";if(t.envMap)switch(t.envMapMode){case Ko:e="ENVMAP_MODE_REFRACTION";break}return e}function Lw(t){let e="ENVMAP_BLENDING_NONE";if(t.envMap)switch(t.combine){case hv:e="ENVMAP_BLENDING_MULTIPLY";break;case vS:e="ENVMAP_BLENDING_MIX";break;case _S:e="ENVMAP_BLENDING_ADD";break}return e}function Dw(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:i,maxMip:n}}function Iw(t,e,n,i){const r=t.getContext(),o=n.defines;let s=n.vertexShader,a=n.fragmentShader;const l=Rw(n),u=Pw(n),d=bw(n),f=Lw(n),h=Dw(n),m=yw(n),_=Sw(o),y=r.createProgram();let p,c,v=n.glslVersion?"#version "+n.glslVersion+`
...
-${r}`;if(wc[h])return wc[h];const m=K2(s[0],s[1]);if(m.error)throw new Error(jm[m.error]||jm._DEFAULT);const _=new Date(o),y=nA(m,_),p=y.position,c=y.velocity,v={latitude:Hm(u),longitude:Hm(d),height:f},g=Zv(_),M=aA(p,g),R=sA(p,g),w=cA(v,M),A=Math.sqrt(Math.pow(c.x,2)+Math.pow(c.y,2)+Math.pow(c.z,2)),{azimuth:P,elevation:Y,rangeSat:x}=w,{longitude:E,latitude:k,height:B}=R,V={lng:rA(E),lat:iA(k),elevation:Bm(Y),azimuth:Bm(P),range:x,height:B,velocity:A};return wc[h]=V,V}function gA(t,e=Date.now()){const{lat:n,lng:i}=mA(t,e);return{lat:n,lng:i}}let n_="last-30-days";const i_=()=>n_,vA=t=>{console.log("Hello from config!!"),n_=t},r_=async()=>{const t=i_(),e={};console.log(`FETCHING TLE DATA... ${t}`);try{const n=await fetch(`https://celestrak.org/NORAD/elements/gp.php?GROUP=${t}&FORMAT=TLE`);if(!n.ok)throw new Error(`HTTP error! Status: ${n.status} for group: ${t}`);let i=0;const o=(await n.text()).split(`
`).filter(s=>s.trim()!=="");for(let s=0;s<o.length;s+=3){const a=o[s].trim(),l=o[s+1].trim(),u=o[s+2].trim();if(l&&u){const d=l.split(" ")[1];e[d]={name:a,tle:[l,u]},i++}}console.log(`Fetched ${i} satellites from ${t} group.`)}catch(n){console.error("From 'TLEData.js': ERROR FETCHING BULK TLE DATA... Error:",n)}return e},_A=(t,e,n)=>{const i=(90-t)*(Math.PI/180),r=(e+180)*(Math.PI/180),o=-(n*Math.sin(i)*Math.cos(r)),s=n*Math.sin(i)*Math.sin(r),a=n*Math.cos(i);return[o,a,s]};let Bo=await r_(),uf=Object.keys(Bo).length,Cs=new Float32Array(uf*3);const xA=async t=>{vA(t),console.log(`Loading:  ${t}`),Bo=await r_(),console.log(`${t} loaded`),uf=Object.keys(Bo).length,Cs=new Float32Array(uf*3)},cf=new gi,yA=t=>{const e=new Yv,n=new jv({map:e.load("assets/satellite-dot.png"),transparent:!0,size:.02,depthWrite:!1}),i=new p2(cf,n);t.add(i),setInterval(()=>SA(),500)},SA=async()=>{await Bo;const t=Date.now();let e=1;Object.keys(Bo).forEach(n=>{const i=gA(Bo[n],t);if(i){const{lat:r,lng:o}=i,s=_A(r,o,1.01);Cs[e*3]=s[0],Cs[e*3+1]=s[1],Cs[e*3+2]=s[2],e++}}),cf.setAttribute("position",new ni(Cs,3)),cf.attributes.position.needsUpdate=!0};function MA(){return zt.useEffect(()=>{const t=new h2,e=new Nn(75,window.innerWidth/window.innerHeight,.01,1e3);e.position.z=2;const n=document.getElementById("myThreeJsCanvas"),i=new f2({canvas:n});i.setSize(window.innerWidth,window.innerHeight),i.toneMapping=pv,i.outputColorSpace=zi,i.setPixelRatio(window.devicePixelRatio);const r=new T2(e,i.domElement);r.enableZoom=!0,r.minDistance=1.1,r.maxDistance=10,r.rotateSpeed=1,r.enableDamping=!0,r.dampingFactor=.75,r.autoRotate=!0,r.autoRotateSpeed=1.25;let o;r.addEventListener("start",()=>{r.autoRotate=!1,clearTimeout(o)}),r.addEventListener("end",()=>{o=setTimeout(()=>{r.autoRotate=!0},7e3)});const s=new ws;t.add(s);const a=O2();s.add(a);const l=new S2(16777215,.6);t.add(l);const u=new y2(16777215,1.2);u.position.set(-50,0,6),t.add(u),i.shadowMap.enabled=!0,u.castShadow=!0,a.castShadow=!0,a.receiveShadow=!0,yA(s);const d=()=>{e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),i.setSize(window.innerWidth,window.innerHeight)};window.addEventListener("resize",d,!1);const f=()=>{i.render(t,e),s.rotation.y+=0,r.update(),requestAnimationFrame(f)};return f(),()=>{window.removeEventListener("resize",d),clearTimeout(o)}},[]),Gt.jsx("canvas",{id:"myThreeJsCanvas",style:{width:"100%",height:"100vh"}})}function EA(){const t=["last-30-days","stations","active","cosmos-1408-debris","fengyun-1c-debris","iridium-33-debris","cosmos-2251-debris","weather","resource","sarsat","dmc","tdrss","argos","planet","spire","active","intelsat","SES","eutelsat","iridium","iridium-NEXT","starlink","oneweb","orbcomm","globalstar","swarm","amateur","x-comm","other-comm","gorizont","raduga","molniya","gnss","gps-ops","glo-ops","galileo","beidou","sbas","nnss","musson","science","geodetic","engineering","education","military","radar","cubesat"],[e,n]=zt.useState("last-30-days"),i=r=>{console.log("Group:",r,"selected."),n(r),xA(r)};return Gt.jsxs("div",{children:[Gt.jsx("div",{className:"absolute top-5 left-1/2 transform -translate-x-1/2 text-center text-white bg-gray-900 bg-opacity-80 px-5 py-2 rounded-lg shadow-lg text-4xl",children:"Satellite Tracker"}),Gt.jsx("div",{className:"sidebar h-screen w-[250px] fixed top-0 left-0 bg-gray-800 text-white overflow-y-auto py-5",children:Gt.jsxs("div",{className:"sidebar no-scrollbar h-screen w-[250px] fixed top-0 left-0 bg-gray-800 text-white overflow-y-auto py-5",children:[Gt.jsx("h2",{className:"text-center mb-5 text-2xl",children:"Satellite Groups"}),Gt.jsx("ul",{className:"space-y-2",children:t.map((r,o)=>Gt.jsx("li",{onClick:()=>i(r),className:"bg-blue-900 text-center py-2 hover:bg-gray-600 cursor-pointer",children:Gt.jsx("a",{className:"block text-white",children:r})},o))})]})}),Gt.jsxs("div",{className:"absolute bottom-5 left-1/2 transform -translate-x-1/2 text-center text-white text-sm bg-gray-900 bg-opacity-80 px-5 py-2 rounded-lg shadow-lg text-xl",children:["Currently Displaying: ",Gt.jsx("span",{className:"text-blue-400 uppercase italic font-mono font-extrabold text-2xl ",children:i_()}),"."]})]})}function TA(){return Gt.jsx($y,{children:Gt.jsxs("div",{children:[Gt.jsx(MA,{}),Gt.jsx(EA,{})]})})}sv(document.getElementById("root")).render(Gt.jsx(ig.StrictMode,{children:Gt.jsx(TA,{})}));
