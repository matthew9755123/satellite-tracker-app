...
`).filter(s=>s.trim()!=="");for(let s=0;s<o.length;s+=3){const a=o[s].trim(),l=o[s+1].trim(),u=o[s+2].trim();if(l&&u){const d=l.split(" ")[1];e[d]={name:a,tle:[l,u]},i++}}console.log(`Fetched ${i} satellites from ${t} group.`)}catch(n){console.error("From 'TLEData.js': ERROR FETCHING BULK TLE DATA... Error:",n)}return e},_A=(t,e,n)=>{const i=(90-t)*(Math.PI/180),r=(e+180)*(Math.PI/180),o=-(n*Math.sin(i)*Math.cos(r)),s=n*Math.sin(i)*Math.sin(r),a=n*Math.cos(i);return[o,a,s]};let Bo=await r_(),uf=Object.keys(Bo).length,Cs=new Float32Array(uf*3);const xA=async t=>{vA(t),console.log(`Loading:  ${t}`),Bo=await r_(),console.log(`${t} loaded`),uf=Object.keys(Bo).length,Cs=new Float32Array(uf*3)},cf=new gi,yA=t=>{const e=new Yv,n=new jv({map:e.load("assets/satellite-dot.png"),transparent:!0,size:.02,depthWrite:!1}),i=new p2(cf,n);t.add(i),setInterval(()=>SA(),500)},SA=async()=>{await Bo;const t=Date.now();let e=1;Object.keys(Bo).forEach(n=>{const i=gA(Bo[n],t);if(i){const{lat:r,lng:o}=i,s=_A(r,o,1.01);Cs[e*3]=s[0],Cs[e*3+1]=s[1],Cs[e*3+2]=s[2],e++}}),cf.setAttribute("position",new ni(Cs,3)),cf.attributes.position.needsUpdate=!0};function MA(){return zt.useEffect(()=>{const t=new h2,e=new Nn(75,window.innerWidth/window.innerHeight,.01,1e3);e.position.z=4;const n=document.getElementById("myThreeJsCanvas"),i=new f2({canvas:n});i.setSize(window.innerWidth,window.innerHeight),i.toneMapping=pv,i.outputColorSpace=zi,i.setPixelRatio(window.devicePixelRatio);const r=new T2(e,i.domElement);r.enableZoom=!0,r.minDistance=1.1,r.maxDistance=10,r.rotateSpeed=1,r.enableDamping=!0,r.dampingFactor=.75;const o=new ws;t.add(o);const s=O2();o.add(s);const a=new S2(16777215,.6);t.add(a);const l=new y2(16777215,1.2);l.position.set(-50,0,6),t.add(l),i.shadowMap.enabled=!0,l.castShadow=!0,s.castShadow=!0,s.receiveShadow=!0,yA(o);const u=()=>{e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),i.setSize(window.innerWidth,window.innerHeight)};window.addEventListener("resize",u,!1);const d=()=>{i.render(t,e),o.rotation.y+=0,r.update(),requestAnimationFrame(d)};return d(),()=>{window.removeEventListener("resize",u)}},[]),Gt.jsx("canvas",{id:"myThreeJsCanvas",style:{width:"100%",height:"100vh"}})}function EA(){const t=["last-30-days","stations","active","cosmos-1408-debris","fengyun-1c-debris","iridium-33-debris","cosmos-2251-debris","weather","resource","sarsat","dmc","tdrss","argos","planet","spire","active","intelsat","SES","eutelsat","iridium","iridium-NEXT","starlink","oneweb","orbcomm","globalstar","swarm","amateur","x-comm","other-comm","gorizont","raduga","molniya","gnss","gps-ops","glo-ops","galileo","beidou","sbas","nnss","musson","science","geodetic","engineering","education","military","radar","cubesat"],[e,n]=zt.useState("last-30-days"),i=r=>{console.log("Group:",r,"selected."),n(r),xA(r)};return Gt.jsxs("div",{children:[Gt.jsx("div",{className:"absolute top-5 left-1/2 transform -translate-x-1/2 text-center text-white text-sm bg-gray-900 bg-opacity-80 px-5 py-2 rounded-lg shadow-lg text-4xl",children:"Satellite Tracker"}),Gt.jsx("div",{className:"sidebar h-screen w-[250px] fixed top-0 left-0 bg-gray-800 text-white overflow-y-auto py-5",children:Gt.jsxs("div",{className:"sidebar no-scrollbar h-screen w-[250px] fixed top-0 left-0 bg-gray-800 text-white overflow-y-auto py-5",children:[Gt.jsx("h2",{className:"text-center mb-5 text-2xl",children:"Satellite Groups"}),Gt.jsx("ul",{className:"space-y-2",children:t.map((r,o)=>Gt.jsx("li",{onClick:()=>i(r),className:"bg-blue-900 text-center py-2 hover:bg-gray-600 cursor-pointer",children:Gt.jsx("a",{className:"block text-white",children:r})},o))})]})}),Gt.jsxs("div",{className:"absolute bottom-5 left-1/2 transform -translate-x-1/2 text-center text-white text-sm bg-gray-900 bg-opacity-80 px-5 py-2 rounded-lg shadow-lg text-xl",children:["Currently Displaying: ",Gt.jsx("span",{className:"text-blue-400 uppercase italic font-mono font-extrabold text-2xl ",children:i_()}),"."]})]})}function TA(){return Gt.jsx($y,{children:Gt.jsxs("div",{children:[Gt.jsx(MA,{}),Gt.jsx(EA,{})]})})}sv(document.getElementById("root")).render(Gt.jsx(ig.StrictMode,{children:Gt.jsx(TA,{})}));
